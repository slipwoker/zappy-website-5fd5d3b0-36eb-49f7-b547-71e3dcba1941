    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מלון ניר עציון Resort משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '5fd5d3b0-36eb-49f7-b547-71e3dcba1941',
                    name: data.name || '',
                    email: data.email || '',
